...
function setHeaders (res) {
  ...
  res.setHeader('Content-Security-Policy', 'script-src none; report-uri /client-error?style=green')
...
function makeHandler (mintUnguessable, fsRoot, hostname) {
  ...
  function handle (req, res) {
    ...
    res.setHeader('Content-Security-Policy', // Overrides any from setHeaders
      `script-src 'nonce-${cspNonce}'; report-uri /client-error?style=green`)
